                  ...
                  <div className="row">
                    <div className="col-lg-12">
                      <TextField
                        ...
                        <MenuItem value={Tools.PanViewport} key="PanViewport">Pan Viewport</MenuItem>
                      </TextField>
                    </div>
                  </div>
                  <br/>
                ...
                <CardContent>
                  <div className="row">
                    <div className="col-lg-12">
                      ...
                      <br/>
                      <Typography id="fixCanvas">Fix Canvas Size (use Viewport)</Typography>
                      <Switch 
                            value={this.state.useFixedCanvasSize}
                            onChange={(e) => this.setState({useFixedCanvasSize: !this.state.useFixedCanvasSize})} />
                    </div>
                  </div>
            ...
            <Card style={styles.card}>
              ...
              <Collapse in={this.state.expandBack}>
                <CardContent>
                  ...
                  <FormControlLabel
                    label="Center Contain"
                    control={
                      <Switch
                        value={this.state.centerContained}
                        onChange={(e) => this.setState({ centerContained: !this.state.centerContained })}/>
                    }/>
                  <div>
                    <DropZone
                      accept='image/*'
