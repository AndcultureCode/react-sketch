    ...
    if (options.centerContained) {
        ...
        fabric.Image.fromURL(dataUrl, (img) => {
            ...
            Object.assign(options, {
                originX: 'center',
                originY: 'center',
                top: (this.props.fixCanvasToSize ? this.props.fixCanvasToSize.height : canvas.height) / 2,
                left: (this.props.fixCanvasToSize ? this.props.fixCanvasToSize.width : canvas.width) / 2,
                scaleX: min,
                scaleY: min,
            });
